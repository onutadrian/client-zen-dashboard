      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => setIsAdding(!isAdding)} size="sm" className="bg-yellow-500 hover:bg-neutral-950 text-neutral-950 hover:text-yellow-500 transition-colors">
        ...
        <CardContent>
          {isAdding && <div className="flex space-x-2 mb-4">
              <Input placeholder="Enter team member name or email" value={newMember} onChange={e => setNewMember(e.target.value)} onKeyPress={e => e.key === 'Enter' && handleAddMember()} />
          ...
          {project.team && project.team.length > 0 ? <div className="space-y-3">
              {project.team.map((member, index) => <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Button onClick={() => handleRemoveMember(member)} variant="ghost" size="sm" className="text-red-600 hover:text-red-700">
