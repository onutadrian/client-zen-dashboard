/*
  # Fix for invite code policies

  1. Changes
     - Adds IF NOT EXISTS checks for all policies
     - Ensures all objects are created only if they don't already exist
     - Fixes the trigger creation to avoid conflicts
*/
