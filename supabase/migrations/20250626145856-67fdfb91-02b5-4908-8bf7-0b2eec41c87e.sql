...
DROP POLICY IF EXISTS "Users can view hour entries" ON public.hour_entries;
DROP POLICY IF EXISTS "Users can insert hour entries" ON public.hour_entries;
DROP POLICY IF EXISTS "Users can update hour entries" ON public.hour_entries;
DROP POLICY IF EXISTS "Users can delete hour entries" ON public.hour_entries;
